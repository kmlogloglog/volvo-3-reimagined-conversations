...
class Location(BaseModel):
    ...
    street: Optional[str] = Field(
        default=None, description="The street address (optional)."
    )
...
class Retailer(BaseModel):
    ...
    phone: Optional[str] = Field(
        default=None, description="The retailer's phone number (optional)."
    )
...
class UserInfo(BaseModel):
    ...
    height: Optional[str] = Field(
        default=None, description="The user's height preference to adjust the seat."
    )
    music: Optional[str] = Field(
        default=None,
        description="The user's music preference to adjust the audio system.",
    )
    light: Optional[str] = Field(
        default=None,
        description="The user's lighting/ambience preference to adjust the interior lighting.",
    )
...
class AppointmentSlot(BaseModel):
    ...
    date: str = Field(
        ..., description="The date of the appointment (e.g., YYYY-MM-DD)."
    )
    time: str = Field(..., description="The time of the appointment (e.g., HH:MM).")
    duration: Optional[int] = Field(
        default=None, description="Duration of the appointment in minutes (optional)."
    )
